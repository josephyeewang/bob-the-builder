# Bob the Builder &nbsp; <img src="assets/bob-logo.svg" alt="Bob the Builder logo" height="120" align="center" />
...
2. **AUDIT** — Inspect a product you've already started (yours or someone else's). Bob runs 34 ready-made audits across engineering, UX, AI, security, SEO/AI-search visibility, pricing, strategy, and growth — and tells you what's solid, what's hollow, and what to fix first.
...
5. **Auto Audits Your Project** — 34 ready-made audits pulled from 46+ industry sources (OWASP, Nielsen, April Dunford, Reforge, SR 11-7, ISO Plain Language, the Princeton GEO paper, and more). You don't have to know what to look for — Bob does. Includes a unified SEO + AI-search (AEO/GEO) audit, because almost every product has a website.
...
Bob ships a **34-audit library** — 34 ready-made audits, each attacking the product from a different angle, in 8 categories:
...
- **Bob picks the audits for you** — proposes 6–10 based on what kind of product you have. Confirm with one gate. Or pick "Full Enchilada" to run all 34 before a launch.
...
- **Bob remembers** — each AUDIT, you can re-run the last set, broaden to new angles, or do the full 34.
...
| ❌ **Audits narrowly** — one angle (usually a security scan) and calls it done | ✅ 34 ready-made audits across 8 categories, plus an anti-convergence veto so audits don't push your product toward "best-practice average." |
