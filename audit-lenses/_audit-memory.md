...
The realistic UX: Joe types "let's audit DLL" or invokes AUDIT mode. He does NOT remember which lenses ran last time. He does NOT want to choose from a 33-lens menu cold. He wants Bob to remind him + offer sensible choices.
...
2. **Full Enchilada** — all 33 lenses, the comprehensive scrub
